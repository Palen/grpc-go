...
https://godoc.org/github.com/Palen/grpc-go/keepalive for the options.

## What should I set?

It should be sufficient for most users to set [client
parameters](https://godoc.org/github.com/Palen/grpc-go/keepalive) as a [dial
option](https://godoc.org/github.com/Palen/grpc-go#WithKeepaliveParams).
...
parameters](https://godoc.org/github.com/Palen/grpc-go/keepalive#ServerParameters)
for details.

### Enforcement policy

[Enforcement
policy](https://godoc.org/github.com/Palen/grpc-go/keepalive#EnforcementPolicy) is
