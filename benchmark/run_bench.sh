...
go build -o ${out_dir}/server $GOPATH/src/github.com/Palen/grpc-go/benchmark/server/main.go && go build -o ${out_dir}/client $GOPATH/src/github.com/Palen/grpc-go/benchmark/client/main.go
if [ $? != 0 ]; then
  clean_and_die 1
fi
