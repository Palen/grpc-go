...
[![GoDoc](https://godoc.org/github.com/Palen/grpc-go?status.svg)](https://godoc.org/github.com/Palen/grpc-go)
...
```
$ go get -u github.com/Palen/grpc-go
```

With Go module support (Go 1.11+), simply `import "github.com/Palen/grpc-go"` in
...
Documentation
-------------
- See [godoc](https://godoc.org/github.com/Palen/grpc-go) for package and API
  descriptions.
...
```
$ go get -u github.com/Palen/grpc-go
package github.com/Palen/grpc-go: unrecognized import path "github.com/Palen/grpc-go" (https fetch: Get https://github.com/Palen/grpc-go?go-get=1: dial tcp 216.239.37.1:443: i/o timeout)
```
...
- Without Go module support: `git clone` the repo manually:
  ...
  ```
  git clone https://github.com/grpc/grpc-go.git $GOPATH/src/github.com/Palen/grpc-go
  ```
...
- With Go module support: it is possible to use the `replace` feature of `go
  ...
  ```
  go mod edit -replace=github.com/Palen/grpc-go=github.com/grpc/grpc-go@latest
  go mod tidy
  go mod vendor
  go build -mod=vendor
  ```
