...
[`UnaryClientInterceptor`](https://godoc.org/github.com/Palen/grpc-go#UnaryClientInterceptor)
...
`DialOption`
[`WithUnaryInterceptor`](https://godoc.org/github.com/Palen/grpc-go#WithUnaryInterceptor).

#### Stream Interceptor

[`StreamClientInterceptor`](https://godoc.org/github.com/Palen/grpc-go#StreamClientInterceptor)
...
`DialOption`
[`WithStreamInterceptor`](https://godoc.org/github.com/Palen/grpc-go#WithStreamInterceptor).
...
[`UnaryServerInterceptor`](https://godoc.org/github.com/Palen/grpc-go#UnaryServerInterceptor)
...
`ServerOption`
[`UnaryInterceptor`](https://godoc.org/github.com/Palen/grpc-go#UnaryInterceptor).

#### Stream Interceptor

[`StreamServerInterceptor`](https://godoc.org/github.com/Palen/grpc-go#StreamServerInterceptor)
...
To install the unary interceptor for a Server, configure `NewServer` with
`ServerOption`
[`StreamInterceptor`](https://godoc.org/github.com/Palen/grpc-go#StreamInterceptor).
