...
```shell
$ go get github.com/Palen/grpc-go
```

Then change your current directory to `grpc-go/examples/route_guide`:
```shell
$ cd $GOPATH/src/github.com/Palen/grpc-go/examples/route_guide
```
...
`$GOPATH/src/github.com/Palen/grpc-go/examples/route_guide`, simply:
