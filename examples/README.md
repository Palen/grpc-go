...
```
$ go get -u github.com/Palen/grpc-go/examples/helloworld/greeter_client
$ go get -u github.com/Palen/grpc-go/examples/helloworld/greeter_server
```
...
1. Rebuild the generated Go code
   ...
   ```
   $ go generate github.com/Palen/grpc-go/examples/helloworld/...
   ```
